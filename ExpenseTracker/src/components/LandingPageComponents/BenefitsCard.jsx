...
const BenefitsCard = (props) => {
  ...
  return(
    <div className="container flex items-center justify-between  bg-[#f4edff] my-10  py-5 
    2xl:w-300 2xl:h-100 2xl:rounded-[48px] 2xl:px-25
    xl:w-250 xl:h-85 xl:rounded-[40px] xl:gap-13 xl:px-20
    lg:w-210 lg:h-85 lg:rounded-[30px] lg:gap-13 lg:px-20
    md:w-170 md:h-75 md:rounded-[20px] md:gap-13 md:px-15
    sm:w-145 sm:h-65 sm:rounded-[15px] sm:gap-13 sm:px-10
    ">
