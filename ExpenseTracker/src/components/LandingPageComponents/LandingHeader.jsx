...
const LandingHeader = () => {
  return(
    <header className='2xl:w-full xl:w-full lg:w-full md:w-full sm:w-full bg-[#f4edff] h-20 flex justify-around items-center'>
      <img src={Logo} alt="ExpenSync-Logo" className='w-auto h-20 cursor-pointer' />
      <div className="btn">
        <button type="button" className="text-white bg-[#00093c] hover:bg-[#1a1f5c] focus:outline-none focus:ring-4 focus:ring-white-300 font-medium rounded-full text-sm px-5 py-2.5 text-center cursor-pointer mr-3 md:mr-1 sm:mr-1">Log in</button>
