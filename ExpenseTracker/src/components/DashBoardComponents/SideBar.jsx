      ...
      <main className='pl-5 pr-5 pt-7 pb-7'>
        ...
        <nav className='h-175'>
          <ul>
            ...
            <NavLink to="/Dashboard/Data" className='text-[#00093c] cursor-pointer hover:bg-[#E9ECEF] active:bg-[#E9ECEF] h-13 flex items-center font-medium pl-5'>Analytics</NavLink>
          </ul>
        </nav>
