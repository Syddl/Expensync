    ...
    <div className='flex h-screen'>
      <div className=' w-[60%] flex justify-center items-center'>
        <form action="" className="FormContainer w-120 flex flex-col items-center">
          ...
          <button className='bg-[#f2f0ef] w-20 h-10 flex justify-center items-center rounded-3xl border-solid border border-[#7c7b7b44] mb-5 cursor-pointer'><img src={Google} alt="google" className='w-5 h-5'/></button>
          ...
          <p className='text-md'>Don't have an account?
            <Link to="/Signup">
              <span className='text-violet-800 cursor-pointer'> Sign up</span>
            </Link>
          </p>
        </form>
      </div>
